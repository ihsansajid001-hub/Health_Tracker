        ...
        <div className="bg-white dark:bg-gray-800 rounded-3xl p-10 lg:p-14 shadow-xl">
          ...
          <div className="flex items-center justify-between flex-wrap gap-6">
            ...
            <div className="flex items-center gap-4">
              <div className="w-14 h-14 rounded-full overflow-hidden border-2 border-blue-100 dark:border-blue-900">
            ...
            <div className="flex items-center gap-3">
              <button
                ...
                className="w-12 h-12 rounded-full bg-gray-100 dark:bg-gray-700 hover:bg-blue-600 hover:text-white dark:hover:bg-blue-600 flex items-center justify-center transition-all">
