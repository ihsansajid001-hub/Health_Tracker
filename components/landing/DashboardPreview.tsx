...
export default function DashboardPreview() {
  const features = [
    {
      ...
      description: 'Real-time overview of your wellness across all categories',
      link: '/dashboard'
    },
    {
      icon: (
      ...
      description: 'Daily mood check-ins with AI-powered insights',
      link: '/dashboard/mind'
    },
    {
      icon: (
      ...
      description: 'Track workouts, steps, and physical activities',
  ...
  return (
    <section className="py-20 lg:py-32 px-8 sm:px-12 lg:px-16 bg-gradient-to-br from-indigo-50 via-purple-50 to-pink-50 rounded-[32px] md:rounded-[48px] shadow-xl hover:shadow-2xl transition-all duration-300 hover:-translate-y-2">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            Access all your wellness tracking tools, AI insights, and progress analytics from a beautiful, intuitive dashboard.
          </p>
        </div>
        ...
        <div className="text-center">
          <Link
            href="/dashboard"
            className="inline-flex items-center gap-2 px-8 py-4 bg-gradient-to-r from-blue-600 to-indigo-600 text-white text-lg font-semibold rounded-2xl hover:from-blue-700 hover:to-indigo-700 transition-all shadow-lg hover:shadow-xl"
          >
