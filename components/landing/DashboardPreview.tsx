...
const services = [
  { num: '01', title: 'Sleep Tracking',    desc: 'Monitor sleep quality, cycles, and patterns with smart analysis.',       href: '/signup' },
  { num: '02', title: 'Fitness & Activity', desc: 'Log workouts, track steps, and measure physical performance.',           href: '/signup' },
  { num: '03', title: 'Nutrition Logging',  desc: 'Barcode scanning, meal planning, and macro tracking.',                   href: '/signup' },
  { num: '04', title: 'Mental Wellness',    desc: 'Mood tracking, CBT techniques, meditation, and journaling.',             href: '/signup' },
  { num: '05', title: 'Hydration Goals',    desc: 'Smart reminders and weather-adjusted daily water targets.',              href: '/signup' },
];
    ...
    <section className="py-20 lg:py-28 px-8 sm:px-12 lg:px-16 bg-gray-50 dark:bg-gray-900 rounded-[40px] md:rounded-[56px] shadow-xl card-lift">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid lg:grid-cols-2 gap-10 items-end mb-16">
          <div>
            <p className="section-tag mb-5">// Health Pillars</p>
          ...
          <p className="text-lg text-gray-600 dark:text-gray-400 leading-relaxed max-w-md lg:ml-auto">
            LifeScore is built around 5 core health pillars. From daily tracking to AI insights — we've got your wellness covered.
          </p>
        </div>
        ...
        <div className="space-y-0 border-t border-gray-200 dark:border-gray-700">
          {services.map((s, i) => (
            <Link key={i} href={s.href}
              className="group flex items-center gap-6 py-7 border-b border-gray-200 dark:border-gray-700 hover:bg-orange-50 dark:hover:bg-orange-900/10 transition-colors px-4 -mx-4 rounded-2xl">
              <span className="text-sm font-bold text-gray-400 w-8 flex-shrink-0">{s.num}</span>
        ...
        <div className="mt-12 text-center">
          ...
          <p className="mt-3 text-sm text-gray-500">No credit card required · Free to start</p>
        </div>
      </div>
    </section>
  );
